...
def test_init(self):
  ...
  self.assertEqual(self.new_user.user_name,"NgetichNick")
...
def test_save_multiple_user(self):
  ...
  test_user = User("Nick","Korgoren","NickKorgoren","0714042437","nick@korgoren.com") #new user
  test_user.save_user()
